...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB3     ------> TIM2_CH2 
    */
    HAL_GPIO_DeInit(ENCODER_0A_GPIO_Port, ENCODER_0A_Pin);

    HAL_GPIO_DeInit(ENCODER_0B_GPIO_Port, ENCODER_0B_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB5     ------> TIM3_CH2 
    */
    HAL_GPIO_DeInit(GPIOB, ENCODER_1A_Pin|ENCODER_1B_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PB7     ------> TIM4_CH2 
    */
    HAL_GPIO_DeInit(GPIOB, ENCODER_2A_Pin|ENCODER_2B_Pin);
